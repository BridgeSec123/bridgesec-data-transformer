...
class AppOauthApiScopeViewSet(BaseAppViewSet):
    ...
    def extract_data(self, okta_data, parent_record=None):
        """
        Format the OAuth API scope data.
        Receives parent_record (OAuth app object) to extract app_id/label.
        """
        ...
        logger.warning("No valid issuer or scopes found for app_label %s", parent_record.get("app_id"))
        return []
