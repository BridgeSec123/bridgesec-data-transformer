...
class AppSecurePasswordStoreSerializer(serializers.Serializer):
    label = serializers.CharField(required=True)
    password_field = serializers.IntegerField(required=True)
    url = serializers.CharField(required=True)
    username_field = serializers.CharField(required=True)
    accessibility_error_redirect_url = serializers.CharField(required=False, allow_null=True)
    accessibility_login_redirect_url = serializers.CharField(required=False, allow_null=True)
    accessibility_self_service = serializers.CharField(required=False, allow_null=True)
    admin_note = serializers.CharField(required=False, allow_null=True)
    app_links_json = serializers.CharField(required=False, allow_null=True)
    auto_submit_toolbar = serializers.BooleanField(required=False, allow_null=True)
    credentials_scheme = serializers.CharField(required=False, allow_null=True)
    enduser_note = serializers.CharField(required=False, allow_null=True)
    hide_ios = serializers.BooleanField(required=False, allow_null=True)
    hide_web = serializers.BooleanField(required=False, allow_null=True)
    logo = serializers.CharField(required=False, allow_null=True)
    optional_field1 = serializers.CharField(required=False, allow_null=True)
    optional_field1_value = serializers.CharField(required=False, allow_null=True)
    optional_field2 = serializers.CharField(required=False, allow_null=True)
    optional_field2_value = serializers.CharField(required=False, allow_null=True)
    optional_field3 = serializers.CharField(required=False, allow_null=True)
    optional_field3_value = serializers.CharField(required=False, allow_null=True)
    reveal_password = serializers.BooleanField(required=False,allow_null=True)
    shared_password = serializers.CharField(required=False, allow_null=True)
    shared_username = serializers.CharField(required=False, allow_null=True)
    status = serializers.CharField(required=False, allow_null=True)
    timeouts = serializers.ListField(child=serializers.CharField(), required=False, allow_null=True)
...
class AppThreeFieldSerializer(serializers.Serializer):
    label = serializers.CharField(required=True)
    url = serializers.CharField(required=True)
    username_selector = serializers.CharField(required=True)
    password_selector = serializers.CharField(required=True)
    extra_field_value = serializers.CharField(required=True)
    extra_field_selector = serializers.CharField(required=True)
    button_selector = serializers.CharField(required=True)
    accessibility_error_redirect_url = serializers.CharField(required=False, allow_null=True)
    accessibility_login_redirect_url = serializers.CharField(required=False, allow_null=True)
    accessibility_self_service = serializers.CharField(required=False, allow_null=True)
    admin_note = serializers.CharField(required=False, allow_null=True)
