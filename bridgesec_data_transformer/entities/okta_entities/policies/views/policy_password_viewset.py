    ...
    def extract_data(self, okta_data):
        ...
        for record in extracted_data:
            ...
            formatted_record = {
                ...
                "password_auto_unlock_minutes": complexity.get("lockout",{}).get("autoUnlockMinutes",""),
                ...
                "password_max_lockout_attempts": lockout.get("maxAttempts"),
                ...
                "skip_unlock": complexity.get("lockout",{}).get("skipUnlock"),
