...
class AuthorizationServerClaimDefaultViewSet(BaseAuthServerViewSet):
    okta_endpoint = "/api/v1/authorizationServers/default"
    entity_type = "auth_servers_claim_default"
    serializer_class = AuthorizationServerClaimDefaultSerializer
    model = AuthorizationServerClaimDefault
