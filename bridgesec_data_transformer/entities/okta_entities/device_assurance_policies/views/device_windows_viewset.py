...
class DeviceWindowsViewSet(BaseDeviceAssurancePolicyViewSet):
    
    entity = "okta_policy_device_assurance_windows"
    serializer_class = DeviceWindowsSerializer
    model = DeviceWindows
        ...
        for record in okta_data:
            if record.get("platform") == "WINDOWS":
                ...
                formatted_record = {
                    ...
                    "tpsp_crowd_strike_agent_id": third_party_signal_providers.get("crowdStrikeAgentId", ""),
                    "tpsp_crowd_strike_customer_id": third_party_signal_providers.get("crowdStrikeCustomerId", ""),
                    ...
                    "tpsp_secure_boot_enabled": third_party_signal_providers.get("secureBootEnabled", False),
                    "tpsp_site_isolation_enabled": third_party_signal_providers.get("siteIsolationEnabled", False),
                    "tpsp_third_party_blocking_enabled": third_party_signal_providers.get("thirdPartyBlockingEnabled", False),
                    "tpsp_windows_machine_domain": third_party_signal_providers.get("windowsMachineDomain", ""),
