...
class AuthenticatorSerializer(serializers.Serializer):
    ...
    provider_host = serializers.CharField(required=False, allow_blank=True, max_length=255)
    provider_hostname = serializers.CharField(required=False, allow_blank=True, max_length=255)
    provider_integration_key = serializers.CharField(required=False, allow_blank=True, max_length=255)
    provider_json = serializers.CharField(required=False, allow_blank=True)
    provider_secret_key = serializers.CharField(required=False, allow_blank=True, max_length=255)
    provider_shared_secret = serializers.CharField(required=False, allow_blank=True, max_length=255)
    provider_user_name_template = serializers.CharField(required=False, allow_blank=True, max_length=255)
