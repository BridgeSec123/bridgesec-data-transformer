...
MAPPED_ENTITIES_HELPERS = {
    ...
    "entity_unique_fields": {
        ...
        "okta_rate_limit_admin_notification":"notification_id",
        "okta_rate_limit_warning_threshold_percentage":"threshold_id",
        "okta_entitlement_bundle":"bundle_id",
...
ID_KEYS = {
    ...
    "okta_auth_server_clients":"token_id",
    "okta_app_token":"token_id",
    "okta_auth_server_keys":"key_id",
    "okta_group_memberships":"group_id",
    "okta_review":"review_id",
    "okta_principal_entitlements":"entitlement_id",
    "okta_request_conditions":"condition_id",
    "okta_request_sequences":"sequence_id",
    "okta_request_v2":"request_id",
    "okta_catalog_entry_default":"entry_id",
    "okta_catalog_entry_user_access_request_fields":"field_id",
    "okta_end_user_my_requests":"request_id",
    "okta_app_connection": "app_id",
    "okta_app_federated_claim": "app_id",
    "okta_app_push_groups": "app_id",
